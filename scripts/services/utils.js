...
define(['./module'], function (factories) {
    'use strict';
    factories.factory('utils', function () {
        ...
        return {
            ...
            monthNames: function() { return ([this.localize.getLocalizedString('_jan_'),
                this.localize.getLocalizedString('_feb_'),
                this.localize.getLocalizedString('_mar_'),
                this.localize.getLocalizedString('_apr_'),
                this.localize.getLocalizedString('_may_'),
                this.localize.getLocalizedString('_jun_'),
                this.localize.getLocalizedString('_jul_'),
                this.localize.getLocalizedString('_aug_'),
                this.localize.getLocalizedString('_sep_'),
                this.localize.getLocalizedString('_oct_'),
                this.localize.getLocalizedString('_nov_'),
                this.localize.getLocalizedString('_dec_')
            ])},
