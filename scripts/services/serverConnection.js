'use strict';
window.serverName = 'http://www.yonigo.mobi';  // 'http://0.0.0.0';//
window.port = ':8080';

define(['./module'], function (factories) {
    'use strict';
    factories.factory('serverConnection', ['$http', '$rootScope', '$q', function ($http, $rootScope, $q) {
        var connection = {
            ...
            submitForm: function(contact) {
                return this.sendHttp('', contact, connection.url + 'contact');
            },
